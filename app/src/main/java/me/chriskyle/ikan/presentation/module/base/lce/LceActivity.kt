 ...
 */
abstract class LceActivity<V : MvpLceView, P : MvpLcePresenter<V>> : BaseActivity<V, P>(),
    ...
    override val layout: Int
        get() = R.layout.activity_lce

    @SuppressLint("RestrictedApi")
    override fun initView() {
        super.initView()

        refreshLayout?.refreshHeader = MaterialHeader(this)
                .setShowBezierWave(true)
                .setColorSchemeColors(ContextCompat.getColor(this, R.color.refresh_indicator_color))
        refreshLayout?.refreshHeader?.setPrimaryColors(ContextCompat.getColor(this, R.color.refresh_header_bg_color))
        refreshLayout?.refreshFooter = BallPulseFooter(this)
                .setSpinnerStyle(SpinnerStyle.Scale)
                .setIndicatorColor(ContextCompat.getColor(this, R.color.loadmore_indicator_color))
                .setNormalColor(ContextCompat.getColor(this, R.color.loadmore_indicator_color))
                .setAnimatingColor(ContextCompat.getColor(this, R.color.loadmore_indicator_color))
